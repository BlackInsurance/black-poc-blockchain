...
NETWORK_ADMIN_CARD_PATH="$ORIGINAL_PATH/keys/networkadmin.card"
...
BLACK_INSURANCE_MANAGER_CARD_PATH="$ORIGINAL_PATH/keys/agencymanager.card"
BROKER_ID="BROKER"
BROKER_CARD="broker@$NETWORK_NAME"
BROKER_CARD_PATH="$ORIGINAL_PATH/keys/broker.card"
...
SYNDICATE_1_MANAGER_CARD_PATH="$ORIGINAL_PATH/keys/syndicatemanager.card"
RAIN_ORACLE_ID="RAIN_ORACLE"
RAIN_ORACLE_CARD="rainOracle@$NETWORK_NAME"
RAIN_ORACLE_CARD_PATH="$ORIGINAL_PATH/keys/rainoracle.card"
...
INVESTOR_CARD_PATH_PREFIX="$ORIGINAL_PATH/keys/investor-"

BLCK_DEPOSITED_FOR_GAME=100000
RAIN_THRESHOLD_FOR_AUTOCLAIM=10
